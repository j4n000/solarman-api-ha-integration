...
class SolarmanSensorDescription(SensorEntityDescription):
    ...
    api_key: str
    source: str = "inverter"  # data source: inverter, battery, collector, station
    device_group: str = ""  # UI device grouping (defaults to source if empty)
